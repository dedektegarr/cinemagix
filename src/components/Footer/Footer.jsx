...
const Footer = () => {
  return (
    <div className="container bg-color-dark-1/50 rounded-t-lg mt-16">
      <div className="flex flex-col p-4 md:p-8 md:flex-row gap-6">
        <div className="flex-1">
          <NavbarLogo />
          <p className="mt-4 leading-relaxed text-color-dark-3">
            Cinemagix is a film catalog website that offers access to millions
            of movies for discovery. Users can search for and add films to their
            favorites. This project was developed using React.js and utilizes
            the{" "}
            <Link
              target="_blank"
      ...
      <div className="text-center p-4 text-sm border-t border-color-dark-3/30">
